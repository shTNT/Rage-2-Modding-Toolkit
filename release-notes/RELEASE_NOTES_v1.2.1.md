...
- +6 DLC2 FMOD bank references recovered via cross-orphan manifest mining:
...
- DLC2 (TerrorMania) FMOD family completed
...
- The DLC2 stringlookup (14,894 strings) contains localization text, not asset paths
- Cross-orphan string mining (45M candidates) yielded only the DLC2 FMOD family
